...
import { SocialNetworksBlock } from '~/types/store/pages/privacy-policy';
...
export const SocialNetworks = () => {
  ...
  const onParagraphChange = (index: number, val: JSONContent) => {
    ...
    const newParagraph: SocialNetworksBlock['description'] = {
      ...block.description,
  ...
  return (
    <CollapsibleBlock title="Соціальні мережі">
