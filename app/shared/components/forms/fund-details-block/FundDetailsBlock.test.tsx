...
import FundDetailsBlock, { FundDetailsErrors, FundDetailsValue } from './FundDetailsBlock';
...
const baseValue: FundDetailsValue = {
  fundNumber: '10',
...
describe('FundDetailsBlock', () => {
  ...
  it('calls onChange with an updater that sets fundNumber', async () => {
    ...
    const updater = onChange.mock.calls[0][0] as (prev: FundDetailsValue) => FundDetailsValue;
    expect(updater(baseValue).fundNumber).not.toBe(baseValue.fundNumber);
  });
