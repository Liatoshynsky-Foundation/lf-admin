...
export const FundErrorCodes: Record<keyof typeof FundErrors, string> = {
  NUMBER_ALREADY_EXISTS: 'DUPLICATE_FUND_NUMBER',
...
export const seoFormErrors = {
  uk: {
    ...
    adminTitleMaxLength: 'Значення не може перевищувати 250 символів.',
  ...
  en: {
    ...
    adminTitleMaxLength: 'Value must not exceed 250 characters.',
